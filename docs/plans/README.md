...
| 02.1 | ☐ | TUI keybindings: vi mode (priority) + emacs mode; `~/.editrc` detection; ratatui 1.x upgrade | [STEP-02.1-configuration-keybindings.md](STEP-02.1-configuration-keybindings.md) |
