...
- [ ] **15.3-I** Implement `ZonesAccumulator` in `src/zones.rs`:
...
- [ ] **15.6-I** Add `WBalAccumulator` in `src/wbal.rs`:
...
- [ ] **15.9-T** `tests/exp_weighted_avg.rs::seed_returns_seed_until_first_input`,
